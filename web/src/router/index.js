...
export const routes = [
  ...
  { path: '/termos', name: 'LegalTerms', component: () => import('../views/LegalTerms.vue'), meta: { layout: 'public' } },
  { path: '/privacidade', name: 'LegalPrivacy', component: () => import('../views/LegalPrivacy.vue'), meta: { layout: 'public' } },
  { path: '/cancelamento-reembolso', name: 'LegalCancellation', component: () => import('../views/LegalCancellation.vue'), meta: { layout: 'public' } },
