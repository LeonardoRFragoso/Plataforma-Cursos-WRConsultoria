<template>
  <div class="min-h-screen flex flex-col">
    ...
    <main
      class="flex-1 bg-gradient-to-br from-gray-50 via-primary-50/30 to-gray-50 py-16 lg:py-20"
      data-testid="validate-main"
    >
      <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-8 lg:p-10" data-testid="validate-card">
          <form class="space-y-5" @submit.prevent="handleSubmit">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1.5" for="validate-code-input">
                Código de validação
              </label>
              <input
          ...
          <div v-else-if="result" class="mt-8">
              ...
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-amber-700 mt-1">
                    Este registro foi criado exclusivamente para apresentação e testes da plataforma.
            ...
            >
              ...
              <p v-if="result.revocation_reason" class="text-sm text-red-700 mb-4">
            ...
            >
              ...
              <p class="text-sm text-red-700 mt-3">
                O certificado não foi localizado em nossa base de dados. Confira o código e tente novamente.
              </p>
            </div>
          </div>
        </div>
...
async function handleSubmit() {
  ...
  try {
    ...
    if (err.response?.status === 404 || err.response?.status === 400) {
      result.value = { valid: false, status: 'NOT_FOUND', is_demo: false }
    } else {
